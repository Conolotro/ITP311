...
namespace WebApplication2
{
    public partial class Xray : System.Web.UI.Page
    {
        ...
        {
            const double IMAGE_TO_FONT_RATIO = 0.0333778371161549;
            try
            {
                ...
                Point postionWaterMark = new Point((bmp.Width * 1 / 10), (bmp.Height * 9 / 10));
                graphics.DrawString(Session["LoggedIn"].ToString(), new System.Drawing.Font("Arial", (int)(bmp.Width * IMAGE_TO_FONT_RATIO), FontStyle.Bold, GraphicsUnit.Pixel), brush, postionWaterMark);
