...
namespace ITP311.NYPSMS {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tempuri.org/SMSWebService/SMSService", ConfigurationName="NYPSMS.SMSServiceSoap")]
    public interface SMSServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ITP311.NYPSMS.SMS[] receiveMessage(string SMSAccount, string SMSPassword);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/SMSWebService/SMSService/receiveMessage", ReplyAction="*")]
        System.Threading.Tasks.Task<ITP311.NYPSMS.SMS[]> receiveMessageAsync(string SMSAccount, string SMSPassword);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SMSServiceSoapChannel : ITP311.NYPSMS.SMSServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SMSServiceSoapClient : System.ServiceModel.ClientBase<ITP311.NYPSMS.SMSServiceSoap>, ITP311.NYPSMS.SMSServiceSoap {
        ...
        public ITP311.NYPSMS.SMS[] receiveMessage(string SMSAccount, string SMSPassword) {
            return base.Channel.receiveMessage(SMSAccount, SMSPassword);
        }
        
        public System.Threading.Tasks.Task<ITP311.NYPSMS.SMS[]> receiveMessageAsync(string SMSAccount, string SMSPassword) {
