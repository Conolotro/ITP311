    ...
    <div class="col-sm-6 col-sm-offset-3">
       <div class="panel panel-primary" id = "box">
           <div class="panel-heading">
               <center>  
                <h3 class="panel-title">Login</h3> <i id="lock-icon" class="fa fa-lock"></i></center> 
           </div>
           ...
           <div class="panel-body" >
               ...
               <p>Enter your username and password to log in:</p>
                  ...
                  <form id="form1" runat="server">
                    ...
                    <asp:TextBox type="text" autocomplete="off" name="username" placeholder="Username..."
                   ...
                   <br>
                    ...
                    <br>
                    <a href="nricForgotPassword.aspx" style="font-style:italic;color:#7f8c8d">Forgot Password</a>
