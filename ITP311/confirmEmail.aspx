...
<head runat="server">
    ...
    <title>Silver Medical - email confirmation </title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="panel panel-default notification">
                        <div class="panel-heading">
                            <asp:Literal ID="panelHeading" runat="server"></asp:Literal></div>
                        <div class="panel-body">
                            <asp:Literal ID="panelBody" runat="server"></asp:Literal>
                        </div>
                    </div>
